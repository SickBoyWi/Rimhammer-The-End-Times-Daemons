...
{
    public class HediffCompProperties_DestroyCorpseOnDeath : HediffCompProperties
    {
        ...
        public HediffCompProperties_DestroyCorpseOnDeath()
        {
            this.compClass = typeof(HediffComp_DestroyCorpseOnDeath);
        }
    }
}
